...
void loadVoxelConfig(rclcpp::Node *node, VoxelMapConfig &voxel_config)
{
  ...
  {
    std::vector<int64_t> layer_init_num_64;
    node->get_parameter("lio.layer_init_num", layer_init_num_64);
    voxel_config.layer_init_num_.assign(layer_init_num_64.begin(), layer_init_num_64.end());
  }
